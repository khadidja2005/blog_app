...
const Header = () => {
  return (
    ...
    <header className=' flex justify-between'>
      ...
      <Link to={'/login'} className='flex border border-gray-300 rounded-full py-2 px-4 gap-2 shadow-md shadow-gray-300 items-center '>
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
       <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
      </svg>
      <div className='border bg-gray-500 rounded-full text-white p-1 border-gray-500 overflow-hidden'>
